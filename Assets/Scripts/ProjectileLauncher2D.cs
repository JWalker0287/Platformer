...
public class ProjectileLauncher2D : MonoBehaviour
{
    ...
    public int Shoot (Vector2 direction, Vector2 parentVelocity = default(Vector2)) {
        ...
        if (Time.time - launchTime > launchDelay) {
            ...
            for (int i = 0; i < projectileCount; i++) {
                ...
                Vector2 fuzzedDir = Quaternion.AngleAxis(180 * Random.Range(accuracy-1, 1-accuracy), Vector3.forward) * direction;
